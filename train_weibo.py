...
from utils import load_HXbank_dict, load_HXbank_data, get_k_fold_idx, load_weibo_data
...
parser.add_argument('--voc-dict-path', default='./data/weibo_dict/weibo_words_voc_dict_70', help='Select the dictionary')
...
def run(model, optimizer, train_loader, test_loader, fold_i):
    ...
    model_path = './save_model/best_checkpoint_n.pth'
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if res_test[3] > max_AUC:
            max_AUC = res_test[3]
            decline = 0
            save_path = './save_model/weibo_best_model_70_{}.pth'.format(fold_i)
